...
public:
    Machine(uintmax_t, int, PNEGraph);
    void Cycle();
...
Machine::Machine(uintmax_t ruleNr, int nrNodes, PNEGraph graph) {
    m_ruleNr = ruleNr;
    m_nrNodes = nrNodes;
    m_graph = graph;
