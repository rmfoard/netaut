...
a simple program  that how local changes should be applied, based on the state
of each node and its two topological neighbors.
...
is the random machine (59.3\% vs. 99.9\%). Among runs ending in collapse,
machine C executes roughly twice as many iterations as the R machine (Fig. \ref{fig:fig1}.)
