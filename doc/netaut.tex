...
\title{Emergence in Network Automata} % Article title
\author{%
...
\begin{abstract}
\noindent The behavior of % Dummy abstract text - replace \blindtext with your abstract text
a simple network automaton is examined with the goal of producing a respectable
