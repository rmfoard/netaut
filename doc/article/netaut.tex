...
A rule-based automaton, designated \textbf{Machine C}, was designed and implemented in simulation.
...
throughout execution by "pruning," as described in \textit{Structure Invariants}.
...
all nodes have out-degree 2; in-degree can vary from 0 to N. Each node is assigned
