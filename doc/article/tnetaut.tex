...
\caption{Four iterations of machine \textbf{C}, rule fixrule,
...
presented, followed by sections on more specific aspects of behavior.
...
\begin{marginfigure}
  \vspace{-4.5cm}
  \includegraphics{outcomes-nriter-avg.png} \\
  \caption{Average number of iterations for machine \textbf{C} (cycling),
\textbf{C} (collapsing), and \textbf{R} (collapsing).}
  \label{fig:OutcomesNriter}
\end{marginfigure}

\begin{marginfigure}
  \vspace{1cm}
  \includegraphics{outcomes-finnn-dist.png} \\
  \caption{Distribution of terminal graph sizes for machine \textbf{C} (cycling),
\textbf{C} (collapsing), and \textbf{R} (collapsing) with initial graph size 1031.}
  \label{fig:OutcomesFinnn}
\end{marginfigure}

\clearpage

\subsection{Number of Iterations and Terminal Graph Size}

There is remarkable consistency in the way that terminal graph size varies
with number of iterations, cycling vs. collapsing outcomes (Figure \ref{fig:NriterXFinnn}.
...
\includegraphics[width=4cm]{rcol_stepdown.png}
...
\includegraphics[width=4cm]{ccol_stepdown.png}
