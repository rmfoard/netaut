...
\subsection{Simple Machine Learning}
...
of out-degrees is always flat at that value. In-degrees may vary unconstrained as successive
...
plots the distribution for a very rare case having the power-law distribution that appears
