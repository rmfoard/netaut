...
a large number of (separate) connected components. A "fitness" function is defined
...
attempting to improve its aggregate fitness by iteratively replacing
...
more of their components to exchange. The likelihood of a mutation occurring
is controlled by the \textit{probMutation} parameter.

The search proceeds in generations. Each new generation creates a new
...
the chosen "parent" rules and their new offspring to the new pool until
