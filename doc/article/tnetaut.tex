...
intuitive---because they allow multi-edges, they tend to generate the structures
in Figure \ref{fig:Multiedges}. As these configurations appear, they increasingly limit the
...
the multi-edges effectively shrink "menu" of possible new edge destinations from
which both machines draw when operating on a node's out-edges.

\begin{marginfigure}
\includegraphics{multiedges.png}
