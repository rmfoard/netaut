...
\ffigbox{\includegraphics[width=\linewidth]{outcomes-nriter-avg.png}}%
    {\caption{Average number of iterations for machine \textbf{C} (cycling), \textbf{C} (collapsing), and \textbf{R} (collapsing).}\label{fig:OutcomesNriter}}
\hfill
\ffigbox{\includegraphics[width=\linewidth]{outcomes-finnn-dist.png}}%
    {\caption{Distribution of terminal graph sizes for machine \textbf{C} (cycling), \textbf{C} (collapsing), and \textbf{R} (collapsing) with initial graph size 1031.}\label{fig:OutcomesFinnn}}
    \end{floatrow}
\end{figure}
