...
than twice the run length. \\%
Longer cycling \textbf{C} runs correlate with larger \\%
terminal graphs until terminal size \\%
approaches initial size, at which point \\%
...
those for \textbf{R} inthe large majority \\%
of cases (Figure \ref{fig:figDd1024}).} \\
