...
Per Bak's sandpile avalanches. Firther research specifically focused on
...
It may be useful to explore the possibiliry more thoroughly to see if
it is feasible to discover rules that give rise to useful functional
characteristics in evolving or terminal graph structures.
