...
\setlength{\itemindent}{2em}
    ...
    \textit{L, R, LL, LR, RL,} or \textit{RR}, the value \textit{RL} would be
    encoded in the bit sequence \textit{0,0,0,0,1,0}, indicating
    \textit{L=0, R=0, LL=0, L=0, RL=1, RR=0}.
\end{itemize}
\vspace{2mm}
...
We developed a genetic search algorithm for finding rules that produce terminal
