...
\begin{marginfigure}
\includegraphics[width=45mm]{5iters_0.ps}
\end{marginfigure}

\begin{marginfigure}
\includegraphics[width=45mm]{5iters_1.ps}
\end{marginfigure}

\begin{marginfigure}
\includegraphics[width=45mm]{5iters_2.ps}
\end{marginfigure}

\begin{marginfigure}
\includegraphics[width=45mm]{5iters_3.ps}
\end{marginfigure}

\begin{marginfigure}
\includegraphics[width=45mm]{5iters_4.ps}
\caption{Four iterations of machine \textbf{C} beginning with a randomly
generated 8-node graph and terminating in a static configuration (four
nodes removed after iteration 2 to eliminate multi-edges)}
\end{marginfigure}
