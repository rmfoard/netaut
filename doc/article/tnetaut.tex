...
very dissimilar behaviors and terminal graph states. We developed a genetic
search algorithm for finding rules the produce terminal graph states with
specified characteristics, such as high clustering coefficients, or
a large number of connected components.

The search algorithm xxx
